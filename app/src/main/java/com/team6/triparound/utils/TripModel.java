package com.team6.triparound.utils;
...
public class TripModel implements Serializable {
    ...
    public TripModel(String startloc, String endloc, String date, String time,
                     String tripname, String status, List<String> notes,String dateTime) {
    ...
    public TripModel(String startloc, String endloc, String date,
