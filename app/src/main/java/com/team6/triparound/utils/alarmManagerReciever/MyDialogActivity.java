...
import com.team6.triparound.service.DialognotificationService;
import com.team6.triparound.service.FloatingWindowService;
import com.team6.triparound.utils.TripModel;

import static com.team6.triparound.utils.alarmManagerReciever.AlarmEventReciever.RECEIVED_TRIP;
            ...
            AlertDialog.Builder Builder = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton("Snooze", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(MyDialogActivity.this, "Trip Snooze",
                    ...
                    .setPositiveButton("Start Trip", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Toast.makeText(MyDialogActivity.this, "Trip Will Start",
                                    Toast.LENGTH_SHORT).show();
                            tm.setStatus("Done!");
                    ...
                    .setNeutralButton("Cancel Trip", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Toast.makeText(MyDialogActivity.this, "Trip Canceled",
                                    Toast.LENGTH_SHORT).show();
