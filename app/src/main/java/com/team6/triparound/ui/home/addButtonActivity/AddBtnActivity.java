...
public class AddBtnActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    private void setUpAutoComplete() {
        String[] locations ={"Cairo","Giza","Alexandria","Madīnat as Sādis min Uktūbar","Shubrā al Khaymah"
                ,"Al Manşūrah","Ḩalwān","Al Maḩallah al Kubrá","Port Said", "Suez","Ţanţā","Asyūţ","Al Fayyūm",
                "Az Zaqāzīq","Ismailia","Aswān","Kafr ad Dawwār","Damanhūr","Al Minyā","Damietta","Luxor","Qinā",
                "Sūhāj","Banī Suwayf","Shibīn al Kawm","Al ‘Arīsh","Al Ghardaqah","Banhā","Kafr ash Shaykh",
                "Disūq","Bilbays","Mallawī", "Idfū","Mīt Ghamr","Munūf","Jirjā", "Akhmīm","Ziftá","Samālūţ",
                "Manfalūţ","Banī Mazār","Armant","Maghāghah", "Kawm Umbū", "Būr Fu’ād","Al Qūşīyah",
                "Rosetta","Isnā", "Maţrūḩ","Abnūb","Hihyā","Samannūd","Dandarah", "Al Khārjah" };
